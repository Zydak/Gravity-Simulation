...
void CameraController::Update(const float& delta, Camera& camera, const int& target, Map& gameObjects)
{
    ...
    camera.m_Transform.translation.x = radius * -sin(yaw*(3.1415926535897932384626433832795 /180.0)) * cos((pitch)*(3.1415926535897932384626433832795 /180.0));
    camera.m_Transform.translation.y = radius * -sin((pitch)*(3.1415926535897932384626433832795 /180.0));
    camera.m_Transform.translation.z = -radius * cos((yaw)*(3.1415926535897932384626433832795 /180.0)) * cos((pitch)*(3.1415926535897932384626433832795 /180.0));
