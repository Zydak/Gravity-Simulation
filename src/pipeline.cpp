...
void Pipeline::CreateSimplePipeline(const std::string& vertexPath, const std::string& fragmentPath, const PipelineConfigInfo& configInfo)
{
    assert(configInfo.pipelineLayout != nullptr &&"Cannot create graphics pipeline: no pipelineLayout provided in config info");
    assert(configInfo.renderPass != nullptr &&"Cannot create graphics pipeline: no renderPass provided in config info");
    ...
    auto bindingDescription = SimpleModel::Vertex::GetBindingDescriptions();
    auto attributeDescription = SimpleModel::Vertex::GetAttributeDescriptions();
...
void Pipeline::CreateSkyboxPipeline(const std::string& vertexPath, const std::string& fragmentPath, const PipelineConfigInfo& configInfo)
{
    assert(configInfo.pipelineLayout != nullptr &&"Cannot create graphics pipeline: no pipelineLayout provided in config info");
    assert(configInfo.renderPass != nullptr &&"Cannot create graphics pipeline: no renderPass provided in config info");
    ...
    auto bindingDescription = SkyboxModel::Vertex::GetBindingDescriptions();
    auto attributeDescription = SkyboxModel::Vertex::GetAttributeDescriptions();
...
PipelineConfigInfo Pipeline::LinesPipelineConfigInfo(uint32_t width, uint32_t height) 
{
...
PipelineConfigInfo Pipeline::SimplePipelineConfigInfo(uint32_t width, uint32_t height) 
{
    PipelineConfigInfo configInfo{};
